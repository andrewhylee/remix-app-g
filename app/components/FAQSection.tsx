...
export const FAQSection: React.FC = () => {
  ...
  return (
    <div className="FAQSection scroll-section w-full bg-indigo-950 px-6 pt-4 pb-8">
      <div className="flex flex-wrap flex-1 gap-3 size-full max-md:max-w-full">
        <div className="px-12 py-20 flex-1 font-semibold bg-orange-50 rounded-3xl border border-white border-solid min-w-60 max-md:px-5 max-md:max-w-full">
        ...
        <div className="flex-1 shrink bg-orange-600 rounded-3xl basis-24 min-w-60 max-md:max-w-full">
